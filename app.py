...
class Bdenvio:
    def __init__(self):
        # Criar layout
        layout = [
            [sg.Text('codmot', size=(12, 0)), sg.Input(
                size=(5, 0), key='codmot')],
            [sg.Text('dtcte', size=(12, 0)), sg.Input(
                size=(10, 0), key='dtcte')],
            [sg.Text('numcte', size=(12, 0)), sg.Input(
                size=(10, 0), key='numcte')],
            [sg.Text('v_frete', size=(12, 0)), sg.Input(
                size=(10, 0), key='v_frete')],
            [sg.Text('diesel', size=(12, 0)), sg.Input(
                size=(10, 0), key='diesel')],
            [sg.Text('V_varla', size=(12, 0)), sg.Input(
                size=(10, 0), key='V_varla')],
            [sg.Text('v_pneu', size=(12, 0)), sg.Input(
                size=(10, 0), key='v_pneu')],
            [sg.Text('v_oficina', size=(12, 0)), sg.Input(
                size=(10, 0), key='v_oficina')],
            [sg.Text('v_desp_viag', size=(12, 0)), sg.Input(
                size=(10, 0), key='v_desp_viag')],
            [sg.Text('v_outras_desp', size=(12, 0)), sg.Input(
                size=(10, 0), key='v_outras_desp')],
